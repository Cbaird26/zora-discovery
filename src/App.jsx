...
function DiscoveryTab({ discoveryMode }) {
  return <DiscoveryHost mode={discoveryMode} />;
}
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "20px 18px" }}>
        <div style={{ marginBottom: 18 }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
            <h1 style={{ margin: 0, fontSize: 22, fontWeight: 700, color: "#fff", fontFamily: "'Georgia', serif" }}>Zora Discovery</h1>
            <span style={{ fontSize: 11, color: P.glow, letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 600 }}>Compilation · Combined fold engine + bridge lab</span>
          </div>
        ...
        {activeDevice.discovery ? (
          <Comp discoveryMode={activeDevice.discoveryMode} />
        ) : (
